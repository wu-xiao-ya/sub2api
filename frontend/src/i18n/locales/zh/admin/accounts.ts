export default {
    ...
    accounts: {
      ...
      upstreamBilling: {
        ...
        manualRate: '手动上游成本倍率',
        manualRateHint: '用于成本、利润和低成本调度。启用后优先于自动探测，并按保存时间写入历史快照。',
        manualRateValue: '手动成本倍率：{value}x',
        manualRateApplied: '已覆盖自动探测结果；关闭后回退到自动探测或账号原有成本口径。',
        manualRateInvalid: '手动上游成本倍率必须是大于或等于 0 的有效数字',
        manual: '手动',
      ...
      proxy: '代理',
      noProxy: '无代理',
      useRelayRoute: '使用中转线路',
      useRelayRouteHint: '勾选后出站优先走系统中转；中转连接失败时立即回退到该账号自己的代理或直连。',
      useRelayRouteDisabled: '请先在系统设置 > 网关服务中启用并选择中转代理。',
      relayBadge: '中转',
      concurrency: '并发数',
      loadFactor: '负载因子',
