export default {
    ops: {
      ...
      lastRun: '最近运行',
      lastSuccess: '最近成功',
      upstreamAttributionLastError: '最近错误',
      result: '结果',
      noData: '暂无数据',
      loadingText: '加载中...',
      ready: '就绪',
      ...
      upstreamAttribution: '上游归因',
      upstreamAttributionHint: '按时间范围聚合上游断流、429、5xx 与过载，帮助快速定位异常账号。',
      upstreamAttributionEmpty: '当前时间范围内没有可归因的上游错误。',
      overload: '过载',
      rateLimit: '429',
      serverError: '5xx',
      transport: '网络断开',
      streamFailure: '流式断开',
      averageLatency: '平均上游延迟',
      lastError: '最近错误',
      switchRate: '平均账号切换',
      ...
      tooltips: {
        ...
        upstreamAttribution: '按账号聚合上游过载、429、5xx、网络断开和流式断开，方便定位不稳定线路。',
        goroutines:
