export default {
  ...
  keys: {
    ...
    createKey: '创建密钥',
    createAggregateKey: '创建聚合 Key',
    aggregateBadge: '聚合',
    aggregateMembers: '成员 Key',
    aggregateMembersHint: '按顺序选择普通分组 Key。请求会命中第一把支持该模型的成员。',
    aggregateMembersRequired: '请至少选择一把成员 Key',
    moveMemberUp: '上移',
    moveMemberDown: '下移',
    removeMember: '移除',
    addMember: '添加成员',
    noGroupKeysForAggregate: '请先创建至少一把普通分组 Key',
    editKey: '编辑密钥',
    deleteKey: '删除密钥',
  ...
  usage: {
    ...
    duration: '耗时',
    latency: '延迟',
    latencyFirstToken: '首响',
    latencyFirstResponse: '首响应',
    latencyFirstEvent: '首事件',
    latencyFirstOutput: '首输出',
    latencyFirstCharacter: '首吐字',
    latencyOriginIngress: '口径 V2：从网关接收请求起计时，包含重试等待。',
    latencyOriginForward: '历史口径：从转发开始计时。',
    latencyOriginUnknown: '历史记录未采集分阶段延迟。',
    latencyBeforeForward: '转发前',
    latencyAttempts: '尝试次数',
    latencyObservedOnly: '阶段差值仅表示观测到的等待，不代表上游内部原因。',
    latencyDuration: '总耗时',
    latencyGeneration: '持续生成',
    latencyOutputSpeed: '输出速度',
    latencyAnalysis: '延迟分析',
    latencyStatus: '状态',
    latencyWaitingFirstToken: '等待首 Token',
    latencyGenerationRatio: '持续生成占比',
    latencySmooth: '流畅',
    latencyWarn: '偏慢',
    latencySlow: '缓慢',
    latencyCritical: '严重',
    latencyUnavailable: '暂不可用',
    time: '时间',
    ws: 'WS',
    stream: '流式',
    sync: '同步',
  ...
  availableChannels: {
    performance: {
      ...
      "empty": "暂无数据",
      "low": "样本较少",
      "partial": "部分请求缺少完整终态，成功率仅覆盖已确认结果",
      "error": "性能数据暂时不可用",
    ...
    pricing: {
      ...
      unitPerRequest: '/ 次',
      longContext: '长上下文计费',
      longContextThreshold: '超过 {threshold} Token',
      longContextThresholdLabel: '触发阈值',
      longContextInputMultiplier: '输入/缓存 ×{multiplier}',
      longContextInputMultiplierLabel: '输入/缓存倍率',
      longContextOutputMultiplier: '输出 ×{multiplier}',
      longContextOutputMultiplierLabel: '输出倍率'
    }
  },
