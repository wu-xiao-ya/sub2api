export default {
  ...
  finance: {
    ...
    net: '净变动',
    recordCount: '记录数',
    userPlaceholder: '用户邮箱、名称或 ID',
    excludeUsersPlaceholder: '黑名单：排除邮箱、名称或 ID（逗号分隔）',
    excludeUsersHint: '不计入列表、汇总和 CSV 的用户，支持邮箱、用户名或用户 ID，多个值用逗号、分号或空格分隔',
    keywordPlaceholder: '订单号、兑换码或备注',
    allSources: '全部来源',
    allDirections: '全部方向',
    allPaymentTypes: '全部支付方式',
    paymentTypeAlipay: '支付宝',
    paymentTypeWxpay: '微信支付',
    paymentTypeStripe: 'Stripe',
    paymentTypeAirwallex: 'Airwallex',
    sourcePayment: '在线支付',
    sourceRefund: '退款',
    sourceRedeem: '余额兑换码',
    sourceAdminAdjustment: '管理员调整',
    sourceAffiliateTransfer: '返利转余额',
    directionIncome: '入账',
    directionDeduction: '扣减',
    time: '发生时间',
    user: '用户',
    source: '来源',
    balanceChange: '余额变动',
    ...
    status: '状态',
    exportCsv: '导出 CSV',
    exportFailed: '导出资金流水失败',
    noRecords: '所选时间范围内暂无资金流水',
  },
