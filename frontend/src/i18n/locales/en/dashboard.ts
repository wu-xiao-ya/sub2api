export default {
  ...
  keys: {
    ...
    createAggregateKey: 'Create Aggregate Key',
    aggregateBadge: 'Aggregate',
    aggregateMembers: 'Member keys',
    aggregateMembersHint: 'Choose group keys in order. Requests use the first member that supports the model.',
    aggregateMembersRequired: 'Select at least one member key',
    moveMemberUp: 'Move up',
    moveMemberDown: 'Move down',
    removeMember: 'Remove',
    addMember: 'Add member',
    noGroupKeysForAggregate: 'Create at least one regular group key first',
  ...
  usage: {
    ...
    duration: 'Duration',
    latency: 'Latency',
    latencyFirstToken: 'First response',
    latencyFirstResponse: 'First response',
    latencyFirstEvent: 'First event',
    latencyFirstOutput: 'First output',
    latencyFirstCharacter: 'First text',
    latencyOriginIngress: 'V2: measured from gateway ingress, including retry waits.',
    latencyOriginForward: 'Legacy: measured from forwarding start.',
    latencyOriginUnknown: 'No stage measurements in this historical record.',
    latencyBeforeForward: 'Before forward',
    latencyAttempts: 'Attempts',
    latencyObservedOnly: 'Intervals describe observed waits, not upstream internal causes.',
    latencyDuration: 'Total',
    latencyGeneration: 'Generation',
    latencyOutputSpeed: 'Output speed',
    latencyAnalysis: 'Latency analysis',
    latencyStatus: 'Status',
    latencyWaitingFirstToken: 'Waiting for first token',
    latencyGenerationRatio: 'Generation ratio',
    latencySmooth: 'Smooth',
    latencyWarn: 'Slow',
    latencySlow: 'Very slow',
  ...
  availableChannels: {
    performance: {
      "title": "Performance",
      "firstCharacter": "Avg. first visible text",
      "tps": "Output TPS",
      ...
      "timeline": "Bucket status",
      "empty": "No data",
      "low": "Small sample",
      "partial": "Some requests have no confirmed outcome; success rate covers confirmed results only",
    ...
    pricing: {
      ...
      longContextThreshold: 'Above {threshold} tokens',
      longContextThresholdLabel: 'Trigger threshold',
      longContextInputMultiplier: 'Input/cache x{multiplier}',
      longContextInputMultiplierLabel: 'Input/cache multiplier',
      longContextOutputMultiplier: 'Output x{multiplier}',
      longContextOutputMultiplierLabel: 'Output multiplier'
    }
  },
