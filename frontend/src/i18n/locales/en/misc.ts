export default {
  ...
  payment: {
    ...
    admin: {
      ...
      noOpenaiGroups: 'No groups available',
      noAvailableGroups: 'No groups available',
      imageGroupsWarning: 'Image groups are included. Image usage shares this plan quota.',
  ...
  finance: {
    ...
    net: 'Net Change',
    recordCount: 'Records',
    userPlaceholder: 'Email, name, or user ID',
    excludeUsersPlaceholder: 'Blacklist: exclude email, name, or ID',
    excludeUsersHint: 'Exclude users from the list, totals, and CSV. Separate email, username, or user IDs with commas, semicolons, or spaces.',
    keywordPlaceholder: 'Order number, redeem code, or note',
    allSources: 'All Sources',
    allDirections: 'All Directions',
    allPaymentTypes: 'All Payment Types',
    paymentTypeAlipay: 'Alipay',
    paymentTypeWxpay: 'WeChat Pay',
    paymentTypeStripe: 'Stripe',
    paymentTypeAirwallex: 'Airwallex',
    sourcePayment: 'Online Payment',
    sourceRefund: 'Refund',
    sourceRedeem: 'Balance Redeem Code',
    sourceAdminAdjustment: 'Admin Adjustment',
    sourceAffiliateTransfer: 'Affiliate Transfer',
    directionIncome: 'Credit',
    directionDeduction: 'Deduction',
    time: 'Time',
    user: 'User',
    source: 'Source',
    balanceChange: 'Balance Change',
    direction: 'Direction',
    reference: 'Order / Redeem Code',
    paymentType: 'Payment Method',
    notes: 'Notes',
    status: 'Status',
    exportCsv: 'Export CSV',
    exportFailed: 'Failed to export balance ledger',
    noRecords: 'No balance movements in this date range',
  },
