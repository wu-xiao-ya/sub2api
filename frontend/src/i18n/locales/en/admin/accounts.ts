export default {
    ...
    accounts: {
      ...
      allPoolGroups: 'All Account Pool Groups',
      ungroupedPoolGroup: 'No Pool Group',
      oauthType: 'OAuth',
      ...
      accountPoolGroup: {
        label: 'Account Pool Group',
        hint: 'Groups accounts from the same upstream or separate pools under one upstream. It does not change scheduling yet.',
        none: 'No account pool group',
        manage: 'Manage Account Pool Groups'
      },
      poolGroupManager: {
        title: 'Account Pool Groups',
        listTitle: 'Pool Groups',
        listHint: 'Create multiple pools for the same upstream and mark their source.',
        empty: 'No account pool groups yet',
        noUpstreamKey: 'No upstream key',
        name: 'Pool Name',
        namePlaceholder: 'e.g. AIHub Pro Pool 1',
        nameRequired: 'Pool name is required',
        upstreamKey: 'Upstream Key',
        upstreamKeyPlaceholder: 'e.g. aihub, fengl, official-openai',
        upstreamKeyHint: 'Optional source marker. One upstream can have multiple pool groups.',
        description: 'Description',
        descriptionPlaceholder: 'Record source, purpose, or notes for this pool',
        sortOrder: 'Sort Order',
        created: 'Account pool group created',
        updated: 'Account pool group updated',
        deleted: 'Account pool group deleted',
        failed: 'Account pool group operation failed',
        deleteConfirm: 'Delete account pool group "{name}"? Bound accounts will become ungrouped.'
      },
      platforms: {
        anthropic: 'Anthropic',
        claude: 'Claude',
      ...
      bulkEdit: {
        ...
        poolGroupNotice: 'When checked, selected accounts are bound to this pool group. Choosing "No account pool group" clears the binding.',
      ...
      proxy: 'Proxy',
      noProxy: 'No Proxy',
      useRelayRoute: 'Use relay route',
      useRelayRouteHint: 'Prefer the system relay outbound. If the relay is down, this request falls back to the account proxy or direct connect.',
      useRelayRouteDisabled: 'Enable the system relay and choose a proxy in Settings > Gateway first.',
      relayBadge: 'Relay',
      concurrency: 'Concurrency',
