    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          mode: 'Default monitor view',
          modeHint: 'Only changes the default user view. Active diagnostics and passive traffic trends both continue running.',
          modeV2: 'Real traffic trends',
          modeV1: 'Live diagnostics',
          modeV2Hint: 'Show real-request success, TTFT, cache and trend metrics by default.',
          modeV1Hint: 'Show active probes, account sources and image-check results by default.',
          ...
          hideThroughputHint: 'Admins keep the full metrics. Error rates, latency, cache rates and status are unaffected.',
          accountProbe: {
