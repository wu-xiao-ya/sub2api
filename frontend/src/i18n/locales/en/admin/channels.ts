export default {
    ...
    channels: {
      ...
      form: {
        ...
        webSearchEmulationHint: '?? When enabled, all accounts in this channel\'s Anthropic groups will intercept web_search requests. Use with caution.',
        ...
        bedrockCCCompatHint: '?? When enabled, requests to Bedrock accounts in this channel will be transformed for Claude Code compatibility (thinking type conversion, tool_use ID sanitization).',
    ...
    riskControl: {
      ...
      table: {
        ...
        apiKey: 'API Key',
        endpoint: 'Endpoint',
        sourceMode: 'Monitor source',
        sourceModeDirect: 'Direct upstream',
        sourceModeInternal: 'Station monitoring user Key',
        sourceModeHint: 'Station mode uses the local gateway and does not create customer billing records.',
        internalKey: 'Station monitoring Key',
        internalKeyPlaceholder: 'Choose a configured station monitoring Key',
        internalKeyHint: 'Only the key name and bound group are shown; the secret is never exposed.',
        ensureInternalKeys: 'Initialize station monitoring keys for this platform',
        ensureInternalKeysSuccess: 'Station monitoring keys ready; created {count}',
        ensureInternalKeysFailed: 'Failed to initialize station monitoring keys',
        noMonitoringGroups: 'No monitoring groups are available for this platform',
        internalKeyLoadFailed: 'Failed to load station monitoring keys',
        result: 'Result',
        highest: 'Highest',
        actionMeta: 'Action',
        latency: 'Latency',
    ...
    channelMonitor: {
      ...
      viewLatestImage: 'View the latest generated image',
      latestImageTitle: 'Latest image from {name}',
      latestImageAlt: 'Latest channel monitor generated image',
      noLatestImage: 'No image has been generated successfully yet',
      imageLoadFailed: 'Failed to load the latest generated image',
      ...
      form: {
        ...
        apiModeModelsHint: 'Only calls /v1/models to verify the key and model; no content is generated.',
        apiModeImages: 'Real Image Generation',
        apiModeImagesHint: 'Calls /v1/images/generations to generate one test image and keeps the latest successful one.',
        endpoint: 'Endpoint',
        ...
        accountGroup: 'Account Management Group',
        accountGroupNone: 'Do not use an account management group',
        accountGroupPlaceholder: 'Choose a group matching the current platform',
        accountGroupHint: 'When linked, monitoring probes real accounts from this group with sticky selection. Static upstream settings remain as a compatibility fallback.',
        providerAntigravity: 'Antigravity',
        intervalSeconds: 'Interval (seconds)',
        intervalSecondsHint: 'Range: 15 - 3600 seconds. New real-image monitors default to 1800 seconds (30 minutes).',
        imageRequestTimeoutSeconds: 'Image Wait Time (seconds)',
        imageRequestTimeoutSecondsHint: 'Maximum wait for one real image check. Range: 15 - 900 seconds; defaults to 300 seconds (5 minutes).',
      ...
      forceFullRun: 'Force Full',
      forceFullRunTitle: 'Ignore sticky account selection and run a full candidate check for the current model',
      probeAccount: 'Account: {name}',
      bestAccountEmpty: 'Not recorded',
      probeMode: 'Mode: {mode}',
      probeCandidates: 'Healthy {healthy} / Candidates {candidates}',
      probeCheckedAt: 'Checked: {time}',
      probeModes: {
        static: 'Static',
        sticky: 'Sticky',
        confirm: 'Confirm',
