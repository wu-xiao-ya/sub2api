export default {
    ops: {
      ...
      upstreamAttribution: 'Upstream Attribution',
      upstreamAttributionHint: 'Aggregate upstream disconnects, 429s, 5xx errors, and overloads over the selected time range.',
      upstreamAttributionEmpty: 'No attributable upstream errors were found in the selected time range.',
      overload: 'Overload',
      rateLimit: '429',
      serverError: '5xx',
      transport: 'Transport',
      streamFailure: 'Stream drop',
      averageLatency: 'Avg upstream latency',
      upstreamAttributionLastError: 'Latest error',
      ...
      tooltips: {
        ...
        upstreamAttribution: 'Aggregate upstream overloads, 429s, 5xx errors, network disconnects, and stream drops by account.',
