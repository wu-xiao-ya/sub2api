<template>
  <component :is="props.embedded ? 'div' : AppLayout" :class="props.embedded ? 'contents' : ''">
    <div class="space-y-6 pb-12">
      ...
      <section
        class="border-y border-gray-200 bg-white dark:border-dark-700 dark:bg-dark-900"
      >
        <header class="page-header mb-0 flex flex-wrap items-start justify-between gap-4 border-b border-gray-100 px-5 py-4 dark:border-dark-700 sm:px-6">
          <div class="min-w-0">
            <h1 class="page-title flex items-center gap-2 text-xl font-semibold text-gray-900 dark:text-white">
      ...
      <div class="relative min-h-[320px]">
        ...
        <div
          v-else-if="loading"
          class="card flex min-h-[320px] items-center justify-center !rounded-lg !border-0 text-sm text-gray-400 shadow-none ring-1 ring-gray-900/5 dark:ring-dark-700"
        >
          <span class="animate-pulse">{{ t('common.loading') }}</span>
        </div>
      </div>

      <section class="card flex min-h-0 flex-col overflow-hidden !rounded-lg !border-0 shadow-none ring-1 ring-gray-900/5 dark:!bg-dark-800 dark:ring-dark-700">
