  ...
  <div class="console-chart">
    ...
    <div class="p-6">
      ...
      <div v-else class="space-y-3">
        <div v-for="log in data" :key="log.id" class="flex flex-wrap items-center justify-between gap-3 border-b border-gray-100 py-3 dark:border-dark-800">
          <div class="flex min-w-0 items-center gap-3">
            <ModelIcon :model="log.model" :size="22" />
