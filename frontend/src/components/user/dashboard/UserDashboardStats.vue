<template>
  <!-- Row 1: Core Stats -->
  <div class="console-metric-grid grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
    <!-- Balance -->
    <div v-if="!isSimple" class="stat-cell">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-semibold console-number text-emerald-600 dark:text-emerald-400">${{ formatBalance(balance) }}</p>
    ...
    <div class="stat-cell">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-semibold console-number text-gray-900 dark:text-white">{{ stats?.total_api_keys || 0 }}</p>
    ...
    <div class="stat-cell">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-semibold console-number text-gray-900 dark:text-white">{{ stats?.today_requests || 0 }}</p>
    ...
    <div class="stat-cell">
      <div class="flex items-center gap-3">
        <div class="rounded-lg bg-gray-100 p-2 dark:bg-dark-800">
          <Icon name="dollar" size="md" class="text-gray-900 dark:text-gray-100" :stroke-width="2" />
        </div>
        <div>
          <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.todayCost') }}</p>
          <p class="text-xl font-semibold console-number text-gray-900 dark:text-white">
  ...
  <!-- Row 2: Token Stats -->
  <div class="console-metric-grid grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
    <!-- Today Tokens -->
    <div class="stat-cell">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-semibold console-number text-gray-900 dark:text-white">{{ formatTokens(stats?.today_tokens || 0) }}</p>
    ...
    <div class="stat-cell">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-semibold console-number text-gray-900 dark:text-white">{{ formatTokens(stats?.total_tokens || 0) }}</p>
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p
            ...
            class="text-xl font-semibold console-number text-cyan-600 dark:text-cyan-400"
          >
            {{
              formatCacheHitRate(
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p
            ...
            class="text-xl font-semibold console-number text-sky-600 dark:text-sky-400"
          >
            {{
              formatCacheHitRate(
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1">
          ...
          <div class="flex items-baseline gap-2">
            <p class="text-xl font-semibold console-number text-gray-900 dark:text-white">{{ formatTokens(stats?.rpm || 0) }}</p>
    ...
    <div class="stat-cell">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-semibold console-number text-gray-900 dark:text-white">{{ formatDuration(stats?.average_duration_ms || 0) }}</p>
  ...
  <div v-if="!isSimple && platformCards.length > 0" class="stat-cell">
      ...
      >
        <div class="flex items-center justify-between">
          <span class="text-sm font-semibold text-gray-900 dark:text-white">
            <PlatformIcon v-if="!item.isOther" :platform="item.platform" class="mr-1.5" />
            {{ item.isOther ? t('dashboard.platformOther') : platformLabel(item.platform) }}
          </span>
          <span class="font-mono text-sm text-gray-900 dark:text-gray-100" :title="t('dashboard.actual')">
