<template>
  <div class="card p-4">
    ...
    <div
      ...
      class="flex flex-col items-center gap-4 2xl:flex-row"
    >
    ...
    <div v-else-if="rankingDisplayItems.length > 0 && rankingChartData" class="flex flex-col items-center gap-4 2xl:flex-row">
      <div class="h-40 w-40 shrink-0">
