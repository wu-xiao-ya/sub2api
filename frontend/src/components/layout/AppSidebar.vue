<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      <router-link
        :to="homePath"
        class="sidebar-logo flex h-9 w-9 items-center justify-center overflow-hidden rounded-md transition-opacity hover:opacity-80"
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/account-contributions', label: t('nav.accountContributions'), icon: UsersIcon, hideInSimpleMode: true },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/ops', label: t('nav.ops'), icon: ChartIcon, featureFlag: flagOpsMonitoring },
      { path: '/admin/server-monitor', label: t('nav.serverMonitor'), icon: ServerIcon },
    ...
    { path: '/admin/group-promotions', label: t('nav.groupPromotions'), icon: GiftIcon },
