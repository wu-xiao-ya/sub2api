<template>
  ...
  <svg v-else-if="platform === 'deepseek'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M20.7 4.1c-1.1.1-2 .5-2.7 1.3-.2-.8-.8-1.4-1.5-1.7-.4-.2-.8-.4-1-.8-.1-.2-.2-.5-.3-.8-.1-.2-.2-.3-.4-.3-.2 0-.3.1-.4.3-.3.6-.4 1.2-.4 1.8 0 1.4.6 2.5 1.8 3.3.1.1.2.2.1.3-.1.3-.2.6-.3.8-1.1-.4-1.9-1.1-2.7-1.9-1-.9-1.9-1.8-3-2.5C8.2 3 6.8 2.9 5.6 3.1 2.5 3.7.6 6.3.8 9.4c.2 4.2 3.3 7.3 7.5 7.7 2.1.2 4-.4 5.8-1.8.4.2 1 .3 1.5.3.8.1 1.5-.1 2-.2.5-.1.5-.7.2-.9-1.1-.5-1.4-.4-1.9-.8 1-1.3 1.8-2.8 2-5.1 0-.3 0-.5 0-.8 0-.2 0-.2.2-.3 1.4-.3 2.5-1.1 2.6-2.4.1-.5-.1-.9-.4-1zM11 14.8c-1.7-1.3-2.7-1.8-3.1-1.7-.3 0-.2.4-.1.7.1.3.2.5.4.8.1.2.2.4-.1.6-.7.4-1.8-.1-1.9-.2-1.3-.8-2.2-1.8-2.8-3.1-.6-1.3-.9-2.7-.9-4.2 0-.3.1-.4.4-.5 1.6-.2 3.2.4 4.6 1.5.9.8 1.5 1.8 2.2 2.8.7 1.1 1.5 2 2.5 2.8-.7.3-1.6.5-2.1.5z"/>
  </svg>
  <svg v-else-if="platform === 'kimi'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M4 3h3v7.2L14.5 3H19l-7.2 8.3L20 21h-4.5l-5.4-7.2L7 17.1V21H4V3z"/>
  </svg>
  <svg v-else-if="platform === 'glm'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2.2a9.8 9.8 0 1 0 0 19.6 9.8 9.8 0 0 0 0-19.6zm0 3.1a6.7 6.7 0 1 1 0 13.4 6.7 6.7 0 0 1 0-13.4zm0 2.2a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9z"/>
  </svg>
