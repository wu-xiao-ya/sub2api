...
const defaultBaseUrl = computed(() => {
  ...
  if (props.account?.platform === 'minimax') return 'https://api.minimax.io/v1'
  if (props.account?.platform === 'mimo') return 'https://api.xiaomimimo.com/v1'
  if (props.account?.platform === 'hunyuan') return 'https://api.hunyuan.cloud.tencent.com/v1'
