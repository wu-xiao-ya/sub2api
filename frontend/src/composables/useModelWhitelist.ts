...
const zhipuModels = [
  ...
  'glm-4v-plus', 'glm-5.3-flash', 'glm-5.3', 'glm-5.2', 'glm-5.1', 'glm-5', 'glm-5-turbo',
...
const deepseekModels = [
  'deepseek-v4.1-flash', 'deepseek-flash', 'deepseek-v4-flash-vision-exp',
...
const anthropicPresetMappings = [
  ...
  { label: 'Opus 4.7', from: 'claude-opus-4-7', to: 'claude-opus-4-7', color: 'bg-purple-100 text-purple-700 hover:bg-purple-200 dark:bg-purple-900/30 dark:text-purple-400' },
	{ label: 'Opus 5.5', from: 'claude-opus-5-5', to: 'claude-opus-5-5', color: 'bg-fuchsia-100 text-fuchsia-700 hover:bg-fuchsia-200 dark:bg-fuchsia-900/30 dark:text-fuchsia-400' },
...
const geminiPresetMappings = [
  ...
  { label: '3.8 Flash', from: 'gemini-3.8-flash', to: 'gemini-3.8-flash', color: 'bg-cyan-100 text-cyan-700 hover:bg-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-400' },
...
const grokPresetMappings = [
  ...
  { label: '4.7 Latest', from: 'grok-4.7-latest', to: 'grok-4.7', color: 'bg-lime-100 text-lime-700 hover:bg-lime-200 dark:bg-lime-900/30 dark:text-lime-400' },
  { label: '4.7 Build Fast', from: 'grok-4.7-build-fast', to: 'grok-4.7-build-fast', color: 'bg-cyan-100 text-cyan-700 hover:bg-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-400' },
