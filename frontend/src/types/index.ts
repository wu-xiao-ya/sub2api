...
export interface PublicSettings {
  ...
  /** Preferred user-facing monitor view. Both active and passive layers remain available. */
...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'deepseek' | 'kimi' | 'glm' | 'qwen' | 'minimax' | 'mimo' | 'hunyuan'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'deepseek' | 'kimi' | 'glm' | 'qwen' | 'minimax' | 'mimo' | 'hunyuan'
