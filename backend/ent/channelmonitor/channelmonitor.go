...
func ProviderValidator(pr Provider) error {
	switch pr {
	case ProviderOpenai, ProviderAnthropic, ProviderGemini, ProviderGrok, ProviderAntigravity, ProviderDeepseek, ProviderKimi, ProviderGlm, ProviderQwen, ProviderMinimax, ProviderMimo, ProviderHunyuan:
		return nil
	default:
