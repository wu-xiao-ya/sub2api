...
type UsageLog struct {
	...
	// 内部请求来源，如 channel_monitor
	UsageSource *string `json:"usage_source,omitempty"`
	// GroupID holds the value of the "group_id" field.
	GroupID *int64 `json:"group_id,omitempty"`
	// SubscriptionID holds the value of the "subscription_id" field.
	SubscriptionID *int64 `json:"subscription_id,omitempty"`
	// SubscriptionPurchaseID holds the value of the "subscription_purchase_id" field.
	SubscriptionPurchaseID *int64 `json:"subscription_purchase_id,omitempty"`
...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case usagelog.FieldLatencyBreakdown, usagelog.FieldImageSizeBreakdown:
			values[i] = new([]byte)
		case usagelog.FieldLongContextBillingApplied, usagelog.FieldStream, usagelog.FieldCacheTTLOverridden:
			values[i] = new(sql.NullBool)
		case usagelog.FieldInputCost, usagelog.FieldOutputCost, usagelog.FieldCacheCreationCost, usagelog.FieldCacheReadCost, usagelog.FieldTotalCost, usagelog.FieldActualCost, usagelog.FieldRateMultiplier, usagelog.FieldBaseRateMultiplier, usagelog.FieldAccountRateMultiplier:
			values[i] = new(sql.NullFloat64)
		case usagelog.FieldID, usagelog.FieldUserID, usagelog.FieldAPIKeyID, usagelog.FieldAccountID, usagelog.FieldChannelID, usagelog.FieldGroupID, usagelog.FieldSubscriptionID, usagelog.FieldSubscriptionPurchaseID, usagelog.FieldInputTokens, usagelog.FieldOutputTokens, usagelog.FieldCacheCreationTokens, usagelog.FieldCacheReadTokens, usagelog.FieldCacheCreation5mTokens, usagelog.FieldCacheCreation1hTokens, usagelog.FieldPromotionID, usagelog.FieldBillingType, usagelog.FieldDurationMs, usagelog.FieldFirstTokenMs, usagelog.FieldImageCount, usagelog.FieldVideoCount, usagelog.FieldVideoDurationSeconds:
			values[i] = new(sql.NullInt64)
		case usagelog.FieldRequestID, usagelog.FieldModel, usagelog.FieldRequestedModel, usagelog.FieldUpstreamModel, usagelog.FieldModelMappingChain, usagelog.FieldBillingTier, usagelog.FieldBillingMode, usagelog.FieldUsageSource, usagelog.FieldPromotionName, usagelog.FieldUserAgent, usagelog.FieldIPAddress, usagelog.FieldImageSize, usagelog.FieldImageInputSize, usagelog.FieldImageOutputSize, usagelog.FieldImageSizeSource, usagelog.FieldVideoResolution:
...
func (_m *UsageLog) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usagelog.FieldSubscriptionPurchaseID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field subscription_purchase_id", values[i])
			} else if value.Valid {
				_m.SubscriptionPurchaseID = new(int64)
				*_m.SubscriptionPurchaseID = value.Int64
			}
		...
		case usagelog.FieldPromotionID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
		...
		case usagelog.FieldPromotionName:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field promotion_name", values[i])
			} else if value.Valid {
				_m.PromotionName = new(string)
				*_m.PromotionName = value.String
			}
		case usagelog.FieldBaseRateMultiplier:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field base_rate_multiplier", values[i])
			} else if value.Valid {
				_m.BaseRateMultiplier = new(float64)
				*_m.BaseRateMultiplier = value.Float64
			}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	if v := _m.SubscriptionPurchaseID; v != nil {
		builder.WriteString("subscription_purchase_id=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	if v := _m.PromotionName; v != nil {
		builder.WriteString("promotion_name=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	if v := _m.BaseRateMultiplier; v != nil {
		builder.WriteString("base_rate_multiplier=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
