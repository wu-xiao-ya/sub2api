...
func init() {
	...
	channelmonitorDescRequestTimeoutSeconds := channelmonitorFields[11].Descriptor()
	...
	usagelogDescPromotionName := usagelogFields[27].Descriptor()
	...
	usagelogDescLongContextBillingApplied := usagelogFields[29].Descriptor()
