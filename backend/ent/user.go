...
type User struct {
	...
	// Internal user reserved for channel monitoring
	IsMonitoringUser bool `json:"is_monitoring_user,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldIsMonitoringUser, user.FieldTotpEnabled, user.FieldBalanceNotifyEnabled:
	...
	for i := range columns {
		...
		case user.FieldIsMonitoringUser:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field is_monitoring_user", values[i])
			} else if value.Valid {
				_m.IsMonitoringUser = value.Bool
			}
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("is_monitoring_user=")
	builder.WriteString(fmt.Sprintf("%v", _m.IsMonitoringUser))
	builder.WriteString(", ")
