...
func ProviderValidator(pr Provider) error {
	switch pr {
	case ProviderOpenai, ProviderAnthropic, ProviderGemini, ProviderGrok, ProviderDeepseek, ProviderKimi, ProviderGlm, ProviderQwen, ProviderMinimax, ProviderMimo, ProviderHunyuan:
		return nil
	default:
