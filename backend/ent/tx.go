...
func (tx *Tx) init() {
	...
	tx.GroupPromotion = NewGroupPromotionClient(tx.config)
	...
	tx.SubscriptionPurchase = NewSubscriptionPurchaseClient(tx.config)
	tx.SubscriptionPurchaseGroup = NewSubscriptionPurchaseGroupClient(tx.config)
