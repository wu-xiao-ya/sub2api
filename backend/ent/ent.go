...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			grouppromotion.Table:                grouppromotion.ValidColumn,
			...
			subscriptionpurchase.Table:          subscriptionpurchase.ValidColumn,
			subscriptionpurchasegroup.Table:     subscriptionpurchasegroup.ValidColumn,
