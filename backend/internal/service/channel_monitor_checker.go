...
// thinking token count. Any 2xx that demonstrably ran inference counts —
// thinking-mandatory models (e.g. Opus 5.5) legitimately answer with no
// visible text whenever their effort budget goes to reasoning, regardless of
// the stop reason.
