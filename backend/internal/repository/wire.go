...
var ProviderSet = wire.NewSet(
	...
	NewIntelligenceProbeRepository,   // 降智检测（鹈鹕 SVG 测试）仓储
	NewProxyRepository,
	NewRedeemCodeRepository,
	NewPromoCodeRepository,
	NewAnnouncementRepository,
	NewAnnouncementReadRepository,
	NewGroupPromotionRepository,
	NewUsageLogRepository,
	NewUsageBillingRepository,
	NewContributorRewardRepository,
	...
	NewChannelPerformanceRepository,
	wire.Bind(new(service.ChannelPerformanceRepository), new(*channelPerformanceRepository)),
