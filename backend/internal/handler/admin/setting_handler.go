...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		TrafficRelayEnabled:                                    settings.TrafficRelayEnabled,
		TrafficRelayProxyID:                                    settings.TrafficRelayProxyID,
		TrafficRelayUnavailableTTLSeconds:                      settings.TrafficRelayUnavailableTTLSeconds,
